...
-- 샘플 작가 데이터 (실제 이미지 URL 사용)
INSERT INTO artists (id, name, email, bio, career_years, education, exhibitions_count, awards_count, profile_image) VALUES 
  (1, '김민지', 'minji.kim@gallerypia.com', '현대 디지털 아트와 전통 회화를 융합하는 작가', 8, '서울대학교 미술대학 동양화과 졸업', 15, 3, 'https://i.pravatar.cc/150?img=1'),
  (2, '이준호', 'junho.lee@gallerypia.com', '자연과 인간의 조화를 표현하는 조각가', 12, '홍익대학교 조소과 졸업, 파리 국립미술학교 석사', 23, 7, 'https://i.pravatar.cc/150?img=12'),
  (3, '박서연', 'seoyeon.park@gallerypia.com', 'NFT 네이티브 디지털 아티스트', 5, '한국예술종합학교 미술원 졸업', 8, 2, 'https://i.pravatar.cc/150?img=5'),
  (4, '최현우', 'hyunwoo.choi@gallerypia.com', '사진과 미디어 아트를 결합한 작업', 10, '중앙대학교 사진학과 졸업', 18, 4, 'https://i.pravatar.cc/150?img=13'),
  (5, '정수민', 'sumin.jung@gallerypia.com', '추상 표현주의 화가', 15, '이화여자대학교 서양화과 졸업, 뉴욕 SVA 석사', 30, 9, 'https://i.pravatar.cc/150?img=9');

-- 샘플 작품 데이터 (실제 보이는 이미지 사용)
INSERT INTO artworks (
  ...
  (
    ...
    'https://images.unsplash.com/photo-1549887534-1541e9326642?w=400&h=300&fit=crop',
    3000000, 200, 75, 72,
    87, 83, 80, 88,
  ...
  (
    9, 2, '자연의 순환', '생명의 순환을 형상화한 설치 작품',
    '조각', 'Mixed Media', 200, 300, 2024,
    'https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=800&h=600&fit=crop',
    'https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=400&h=300&fit=crop',
    5000000, 250, 80, 82,
    86, 84, 87, 91,
    35000000, 32000000, 35000000, 'approved'
  ),
  (
    10, 4, '도시의 숨결', '현대 도시의 역동성을 담은 시리즈',
    '사진', 'Digital Photography', 120, 80, 2024,
    'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=800&h=600&fit=crop',
    'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=400&h=300&fit=crop',
    1500000, 40, 85, 75,
    84, 79, 86, 83,
    9000000, 8000000, 9000000, 'approved'
  ),
  (
    11, 3, 'Digital Renaissance', '르네상스 미술을 디지털로 재해석',
    '디지털아트', 'Digital Collage', 2400, 1800, 2024,
    ...
    400000, 90, 87, 80,
    90, 93, 81, 86,
    14000000, 12000000, 14000000, 'approved'
  ),
  (
    12, 1, '동양의 숨결', '전통 수묵화 기법의 현대적 재해석',
    '회화', 'Ink on Paper', 140, 100, 2023,
    'https://images.unsplash.com/photo-1579541814924-49fef17c5be5?w=800&h=600&fit=crop',
    'https://images.unsplash.com/photo-1579541814924-49fef17c5be5?w=400&h=300&fit=crop',
    2500000, 160, 76, 78,
    89, 87, 90, 85,
    22000000, 20000000, 22000000, 'approved'
  );
...
INSERT INTO collections (id, name, description, curator_name, cover_image, artwork_count) VALUES
  (1, '디지털 르네상스', '전통 미술과 디지털 기술의 융합', '김큐레이터', 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=800&h=400&fit=crop', 3),
  (2, '현대 조각의 재해석', '현대 조각 작품 컬렉션', '이큐레이터', 'https://images.unsplash.com/photo-1578926288207-a90a5366759d?w=800&h=400&fit=crop', 2),
  (3, 'NFT 네이티브', '블록체인 기반 디지털 아트', '박큐레이터', 'https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=800&h=400&fit=crop', 2);
